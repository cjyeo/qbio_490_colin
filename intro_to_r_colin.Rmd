...
my_var <- "starlight before daylight, wherever you gaze."
print(my_var)
```
...
birthday <- "12/19/2001"
typeof(birthday)
three_fav_colors <- c("orange", "white", "blue")
...
# write code here
colToAdd <- c()
for (item in mtcars$am) {
  ifelse (item == 0, colToAdd <- c(colToAdd, "automatic"), colToAdd <- c(colToAdd, "manual")) 
}
mtcars$transmission <- colToAdd
```
