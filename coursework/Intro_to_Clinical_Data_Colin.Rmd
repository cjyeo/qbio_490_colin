...
```{r Exercise 4.1}
# create plot here
plot(x=clinical$age_at_initial_pathologic_diagnosis, y=clinical$days_to_last_followup, main="Last Followup vs. Age at Diagnosis", xlab="Age at Diagnosis", ylab="Days since last followup")
```
...
```{r Exercise 4.2}
# create plot here
boxplot(clinical$age_at_initial_pathologic_diagnosis~clinical$vital_status, main="Age vs. Vital Status")
```
