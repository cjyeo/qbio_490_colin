...
```{r}
geneAB_counts <- data.frame(TP53_counts, CD84_counts) # create data frame with geneA_counts and geneB_counts
...
The average number of reads per sample for the combined TP53 + CD84 genes is about 2000-3000. This means that around 2000-3000 occurences of mutations within these genes led to a manifestation of cancer (so having less reads than this means the cancer is less likely to manifest). 
